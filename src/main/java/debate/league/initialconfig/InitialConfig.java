...
public class InitialConfig {
    ...
    CommandLineRunner commandLineRunner(UserRepository userRepository, PostRepository postRepository){
        return args -> {
            ...
            Post post1 = new Post((long)1, (long)-1,(long)-1,"#abcd","My life");
            Post post2 = new Post((long)2, (long)-1,(long)1,"#abcd","Your life");
            post1.setChild((long)2);
            Post post3 = new Post((long)3, (long)-1,(long)-1,"#abcd","Their life");
            Post post4 = new Post((long)4, (long)-1,(long)3,"#abcd","Our life");
